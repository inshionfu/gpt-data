...
CREATE TABLE `user_account` (
  ...
  `model_types` varchar(128) NOT NULL COMMENT '可用模型；glm-flash，glm-4，glm-4v等',
...
VALUES
	(1,'inshion',10,0,'gpt-3.5-turbo,gpt-3.5-turbo-16k',0,'2023-10-03 18:56:13','2023-10-04 10:50:23');
